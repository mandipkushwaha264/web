...
void main() => runApp(MaterialApp(
 debugShowCheckedModeBanner: false,
      title: "Mandip Calculator",
      theme: ThemeData(primaryColor: Colors.blueAccent[700]),
      home: MPCalculator(),
    ));

class MPCalculator extends StatefulWidget {
  @override
  _MPCalculatorState createState() => _MPCalculatorState();
}

class _MPCalculatorState extends State<MPCalculator> {
  var _operation = ['Add', 'Subtraction', 'Multiply', 'Divide','Percentage'];
  var _values ="Add";
  var _displayText = "";
